...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        GiochiDaTavolo gt1 = new GiochiDaTavolo(0, "Taboo", LocalDate.of(1989, 1, 1), 30.99, TipologiaGioco.Gioco_da_Tavolo, 4, 12, Duration.ofMinutes(30));
        GiochiDaTavolo gt2 = new GiochiDaTavolo(0, "Scarabeo", LocalDate.of(1963, 1, 1), 29.99, TipologiaGioco.Gioco_da_Tavolo, 2, 4, Duration.ofMinutes(60));
        GiochiDaTavolo gt3 = new GiochiDaTavolo(0, "Monopoly", LocalDate.of(1935, 1, 1), 26.00, TipologiaGioco.Gioco_da_Tavolo, 2, 6, Duration.ofMinutes(120));
        GiochiDaTavolo gt4 = new GiochiDaTavolo(0, "Pictionary", LocalDate.of(1985, 1, 1), 24.99, TipologiaGioco.Gioco_da_Tavolo, 3, 20, Duration.ofMinutes(30));
        GiochiDaTavolo gt5 = new GiochiDaTavolo(0, "Trivial Pursuit", LocalDate.of(1981, 1, 1), 44.99, TipologiaGioco.Gioco_da_Tavolo, 2, 6, Duration.ofMinutes(90));
